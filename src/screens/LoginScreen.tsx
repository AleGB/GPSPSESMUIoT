...
export const LoginScreen = ({ navigation }: Props) => {
    ...
    const handleLogIn = () => {
        onLogin(navigation, correo, password);
    }
                ...
                <KeyboardAvoidingView style={{ flex: 1 }} behavior={(Platform.OS === 'ios') ? 'padding' : 'height'}>
                    ...
                    <View style={LoginStyles.viewForm}>
                        ...
                        <View style={GlobalStyles.buttonContainerLogin}>
                            {/* onPress={onLogin} */}
                            <ButtonElement title='Iniciar sesión' onPress={handleLogIn} />
                        </View>
                        {/* () => navigation.navigate('HomeScreen') */}
                        <View style={LoginStyles.newAcountView}>
                            <Text style={LoginStyles.passText}>¿No tienes una cuenta?</Text>
                            <TouchableOpacity activeOpacity={0.2} onPress={() => navigation.navigate('RegisterScreen')}>
